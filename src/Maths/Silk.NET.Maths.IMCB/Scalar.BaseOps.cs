...
namespace Silk.NET.Maths
{
    public static partial class Scalar
    {
        ...
        [MethodImpl(MaxOpt)]
        public static bool Equal<T>(T left, T right) where T:unmanaged => left.Equals(right);

        [MethodImpl(MaxOpt)]
        public static bool NotEqual<T>(T left, T right) where T:unmanaged => !left.Equals(right);
